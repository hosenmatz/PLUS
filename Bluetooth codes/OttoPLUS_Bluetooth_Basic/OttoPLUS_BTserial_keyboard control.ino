...
//-- Otto DIY+ basic firmware v3 (ottodiy.com)https://github.com/OttoDIY/PLUS
//-- CC BY SA
//-- 01 March 2017
//-- Adapted Pablo García pabloeweb@gmail.com 
//-----------------------------------------------------------------
#include <Servo.h> 
...
if (Serial.available()) //If something received over bluetooth, store the char
   ...
   switch(dato)
       {//if we receive a...
         ...
         {
            //ESCRIBE AQUÍ TU CÓDIGO PARA CUANDO RECIBAS LA TECLA U
         break;
       }
