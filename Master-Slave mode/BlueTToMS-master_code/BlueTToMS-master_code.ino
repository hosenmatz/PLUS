...
SoftwareSerial BTserialMAIN(13, 14);
...
void loop() 
{
   if(BTserialMAIN.available() > 0)  // Send data only when you receive data:
  {
    data = BTserialMAIN.read();      //Read the incoming data and store it into variable data
    ...
    if(data == '1')            //Checks whether value of data is equal to 1 
   {
    ...
    else if(data == '0')       //Checks whether value of data is equal to 0
    {
     // Forward();
      //for(int i=0;i<4;i++) servo[i].SetPosition(90);
      BTserial.write('0');  //sends a 1 through the bluetooth serial link
    ...
    {
      BTserial.write('3');  //sends a 1 through the bluetooth serial link
     Forward();
     for(int i=0;i<4;i++) servo[i].SetPosition(90);
    }
    else if(data == '4')       //Checks whether value of data is equal to 0
    {
      BTserial.write('4');  //sends a 1 through the bluetooth serial link
      Lwalk();
      for(int i=0;i<4;i++) servo[i].SetPosition(90);
    }
      else if(data == '5')       //Checks whether value of data is equal to 0
    {
      BTserial.write('5');  //sends a 1 through the bluetooth serial link
      Backward();
      for(int i=0;i<4;i++) servo[i].SetPosition(90);
    }
      else if(data == '6')       //Checks whether value of data is equal to 0
    {
      BTserial.write('6');  //sends a 1 through the bluetooth serial link
      Rwalk();
      for(int i=0;i<4;i++) servo[i].SetPosition(90);
    }
    else if(data == '7')       //Checks whether value of data is equal to 0
    {
      BTserial.write('7');  //sends a 1 through the bluetooth serial link
      Lturn();
      for(int i=0;i<4;i++) servo[i].SetPosition(90);
    }
    else if(data == '8')       //Checks whether value of data is equal to 0
    {
      BTserial.write('8');  //sends a 1 through the bluetooth serial link
      Rturn();
      for(int i=0;i<4;i++) servo[i].SetPosition(90);
    }
